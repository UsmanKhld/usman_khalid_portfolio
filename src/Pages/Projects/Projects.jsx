	...
	const experiences = [
		{
			...
			date: "February 2025",
			description: [
				"Developed an Arduino-based system to assess driving performance.",
				"Coded logic in Arduino IDE and integrated a speedometer and camera for real-time data collection.",
				"Connected Arduino to a Python script for analyzing lane stability, turn sharpness, and speed.",
				"Provided self-evaluation metrics to help drivers improve their driving habits.",
			],
			github: "",
			technologies: ["C++", "Linux", "HTTP", "TCP", "Networking"],
		},
		{
			title: "HTTP Server and TCP Client in C++",
			company: "Personal Project",
			date: "January 2025",
			description: [
				"Designed and implemented a simple HTTP server using C++ that listens on port 8080 and responds to client requests with an HTML message.",
				"Built a TCP client that connects to the server, sends HTTP requests, and handles server responses.",
				"Gained experience with low-level networking (TCP/IP), socket programming, and HTTP protocol.",
				"Utilized Linux tools and libraries (sys/socket.h, netinet/in.h) for server-client communication and data transfer",
			],
			github: "",
			technologies: ["C++", "Linux", "HTTP", "TCP", "Networking"],
		},
