	...
	const experiences = [
		{
			...
			description: [
				"Designed and developed a responsive e-commerce website using React for a dessert café, enabling seamless online ordering for 1,000+ monthly visitors.",
				"Integrated Stripe for secure online payments, increasing monthly sales by 20%.",
				"Stored user and cafe data using Firebase, and secure authentication using Firebase.",
			],
